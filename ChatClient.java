...
public class ChatClient implements Runnable, ChatClientInterface {
	...
	public void run() {
		try {
			// Variables
			socket = new Socket(this.getServerAddress(), this.getServerPort()); // TODO STUDENT: create a client socket
																				// with server address and server port
			in = new BufferedReader(new InputStreamReader(socket.getInputStream())); // TODO STUDENT: setup input and
																						// output streams
